...
@section('heading', 'Edit Video_Gallery Page')
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="video_gallery_status" class="form-control">
                                        <option value="1" @if($page_data->video_gallery_status == 1) selected @endif>表示</option>
                                        <option value="0" @if($page_data->video_gallery_status == 0) selected  @endif >非表示</option>
                                    </select>
                                </div>
                                <div class="mb-4">
